...
async function applySetup() {
    try {
        ...
        const sql = fs.readFileSync('onboarding_offboarding_setup.sql', 'utf8');
        ...
        if (error) {
            ...
            if (error.message.includes('function "execute_sql" does not exist')) {
                ...
                console.log('Please copy the contents of "onboarding_offboarding_setup.sql" and run it in your Supabase Dashboard SQL Editor.');
            }
        } else {
